...
document.querySelector(".top-suit").classList.remove("text-danger");
document.querySelector(".bottom-suit").classList.remove("text-danger");
...
generateCard();
document.getElementById("buttonDeal").addEventListener("click", generateCard);
